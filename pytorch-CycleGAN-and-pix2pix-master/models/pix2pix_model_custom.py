...
class Pix2Pix_Custom(BaseModel):
    def name(self):
    ...
    def backward_G(self):
        ...
        # Second, G(A) = B
        self.loss_G_L1_A = self.criterionL1(self.fake_B_1, self.real_B_2) * self.opt.lambda_L1
        self.loss_G_L1_B = self.criterionL1(self.fake_B_2, self.real_B) * self.opt.lambda_L1
